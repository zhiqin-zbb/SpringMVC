...
public class UserController {
	...
	public @ResponseBody Map getUserInfoById(@RequestParam("id") int id) {
	...
	public @ResponseBody Map getUserInfo(@RequestParam("username") String username) {
		Map<String, User> map = new HashMap<String, User>();
	...
	public @ResponseBody Map verify(@RequestParam("username") String username,
			@RequestParam("password") String password) {
